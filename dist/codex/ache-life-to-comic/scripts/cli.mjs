...
async function main() {
  ...
  if (command === "init-book") {
    ...
    const profile = {
      schemaVersion: "1.1.0",
      onboardingVersion: "ache-onboarding/1.0.0",
      designSystemVersion: "ache-design-system/1.0.0",
      bookId,
  ...
  throw new Error(
    "Use onboarding-start, onboarding-answer, onboarding-profile, context, layout, capabilities, target, plan, compound, validate, init-book, append, or inspect"
  );
}
