...
export function validateRenderedHtmlText(html) {
  const failures = [];
  if (!/<meta name="ache-design-system" content="ache-design-system\/1\.2\.0">/u.test(html)) {
    failures.push("missing-design-system-meta");
  }
  if (!/<meta name="ache-renderer" content="ache-monthly-renderer\/2\.0\.0">/u.test(html)) {
